...
public:
    ...
    std::vector<uint8_t> bytesFromFile(std::string inputFilePath);
    std::vector<unsigned char> bytesFromImage(std::string inputFilePath);
    std::string fileFromBytes(const std::string &outputFilePath, std::vector<unsigned char> inp);
